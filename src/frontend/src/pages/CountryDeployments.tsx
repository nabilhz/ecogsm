    ...
    <div>
      ...
      <section style={{ background: "#128C7E" }} className="py-20 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 text-white">
            ...
            <h1
              className="text-7xl md:text-8xl font-bold leading-tight mb-5"
          ...
          <div className="flex-1 flex justify-center">
            <img
              ...
              className="object-cover w-full max-w-[628px] rounded-2xl shadow-lg"
            />
          </div>
        </div>
      </section>
      ...
      <section style={{ background: "#FFD700" }} className="py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2
            className="font-bold mb-4"
            style={{ color: "#1a2e2e", fontSize: "4.2rem", fontWeight: 800 }}
          >
            Interested in deploying EcoGSM in your country?
          </h2>
          <p
            className="mb-8"
            style={{ color: "#1a2e2e", fontSize: "1.43rem", lineHeight: 1.8 }}
          >
