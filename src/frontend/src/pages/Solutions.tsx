    ...
    <div style={{ backgroundColor: "#f0fdf4" }}>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1
            className="text-7xl md:text-8xl font-bold mb-6 leading-tight text-white"
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-10">
            ...
            <p
              ...
              style={{ color: "#64748b", fontSize: "1.43rem", lineHeight: 1.8 }}
            >
              Rural Medicine leveraging on urban medical facility
            </p>
            <p
              className="leading-relaxed max-w-3xl mx-auto"
              style={{ color: "#475569", fontSize: "1.43rem", lineHeight: 1.8 }}
            >
