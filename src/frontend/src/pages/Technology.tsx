        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 flex justify-center">
            <img
              ...
              className="rounded-2xl shadow-xl w-full max-w-[717px] object-cover"
            />
          </div>
        </div>
      </section>
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 mb-12">
            <div className="flex-1">
              ...
              <h2
                ...
                style={{ fontSize: "4.2rem", fontWeight: 800 }}
              >
                See What I See. Touch What I Touch.
              </h2>
              <p
                className="text-gray-700"
                style={{ fontSize: "1.43rem", lineHeight: 1.8 }}
              >
              ...
              <ol className="space-y-4">
                {howItWorks.map((step) => (
                  <li key={step.num} className="flex items-start gap-3">
                    ...
                    <span
                      className="text-gray-700"
                      style={{ fontSize: "1.37rem", lineHeight: 1.7 }}
                    >
                      {step.text}
                    </span>
                  </li>
          ...
          <p
            ...
            style={{ color: "#128C7E", fontSize: "1.43rem" }}
          >
          ...
          <div className="flex flex-col md:flex-row items-start gap-12">
            ...
            <div className="flex-1">
              ...
              <p
                ...
                style={{ fontSize: "1.43rem", lineHeight: 1.8, opacity: 0.9 }}
              >
            ...
            {architecturePrinciples.map((card, i) => (
              ...
              >
                ...
                <h3
                  ...
                  style={{ fontSize: "2.45rem", fontWeight: 700 }}
                >
                  {card.title}
                </h3>
                <p
